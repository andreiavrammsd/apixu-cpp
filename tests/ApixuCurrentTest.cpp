...
namespace {
    ...
    TEST_F(ApixuCurrentTest, success) {
        ...
        EXPECT_EQ("ABCDEFGHIJKLMNOPQRSTUVWXYZ", *current.getLocation().getTimezone());
        ...
        EXPECT_EQ("ABCDEFGHIJKLMNOPQRSTUVW", *current.getCurrent().getCondition().getIcon());
        ...
        EXPECT_EQ("ABCDEFGHIJKLMNOPQRSTUVWXYZAB", *current.getCurrent().getWindDir());
