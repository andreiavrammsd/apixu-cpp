...
namespace ApixuTest {
    ...
    public:
        ...
        static HttpClientMock *GetClient(const string &url, map<string, string> params, int status, const string &body) {
        ...
        static HttpClientMock *GetHttpClient(const string &url, int status, const string &body) {
