...
namespace Apixu {
    namespace Http {
        ...
        class Http {
        public:
            virtual const Response *get(const std::string &path, std::map<std::string, std::string> params) = 0;
        ...
        public:
            ...
            const Response *get(const std::string &url, std::map<std::string, std::string> params) override;
